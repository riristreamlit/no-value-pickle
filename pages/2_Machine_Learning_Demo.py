...
@st.cache_data
def load_model():
    return pickle.load(open('model/RandomForest_PricePrediction.pkl', 'rb'))

@st.cache_data
def load_region_data():
    return pd.read_csv('dataset/Visualization_AirBnB.csv')
...
if st.button('Calculate Price!'):
    ...
    st.write(f"### Your AirBnB's daily rent price is predicted at: $ {your_apartment_price:.3f}")
